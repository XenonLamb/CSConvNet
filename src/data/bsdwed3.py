...
class BSDWED3(srdata.SRData):
    def __init__(self, args, name='BSDWED3', train=True, benchmark=True):
        ...
        super(BSDWED3, self).__init__(
            args, name=name, train=train, benchmark=benchmark
        )

    def _scan(self,half_mode='full'):
        names_hr, names_lr = super(BSDWED3, self)._scan(half_mode='full')
    ...
    def _set_filesystem(self, dir_data):
        super(BSDWED3, self)._set_filesystem(dir_data)
