...
class WED(srdata.SRData):
    def __init__(self, args, name='WED', train=True, benchmark=True):
    ...
    def _scan(self,half_mode='full'):
        names_hr, names_lr = super(WED, self)._scan(half_mode='full')
    ...
    def _set_filesystem(self, dir_data):
        super(WED, self)._set_filesystem(dir_data)
