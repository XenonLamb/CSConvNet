...
class BSDWED(srdata.SRData):
    def __init__(self, args, name='BSDWED', train=True, benchmark=True):
        ...
        super(BSDWED, self).__init__(
            args, name=name, train=train, benchmark=benchmark
        )

    def _scan(self,half_mode='full'):
        names_hr, names_lr = super(BSDWED, self)._scan(half_mode='full')
    ...
    def _set_filesystem(self, dir_data):
        super(BSDWED, self)._set_filesystem(dir_data)
