...
python main.py --model carn --scale 4 --patch_size 96 --save carn_split_x4 --multi_scale --from_legacy --ckpt_path ../checkpoint/carn.pth --batch_size 32 --save_results --neuf
